...
function Input_Digit(digit) {
	...
	//we are checkingif Wait_Second_Operand is true and set
	//Display_Value to the key that was clicked
	if (Wait_Second_Operand === true) {
		Calculator.Display_Value = digit;
		Calculator.Wait_Second_Operand = false;
	} else {
	//this overwrites Display_Value if the current valie is 0
...
function Handle_Operator(Next_Operator) {
	...
	//if operator exists, property lookup is performed fo rth eoperator in the Perform_Calculation object and the function that matches the operator is executed
...
//this section tells the operators what to do
...
//this function updates the screen with the contents od Display_Value
