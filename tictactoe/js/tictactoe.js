...
function placeXOrO(squareNumber) {
	//this condition ensures a quare hasn't been selected already
	//the .some() method is used to check each element of selectedSquare array to see if it contains the quare number clicked on
	if (!selectedSquares.some(element => element.includes(squareNumber))) {
		//this variable retrieved the html element id that was clicked 
		let select = document.getElementById(squareNumber);
		//this condition checks who's turn it is
		if (activePlayer === 'X') {
			//if activePlayeris equal to 'X', the x_2.png is placed in HTML
		...
		//squareNumber and activePlayer are concatenated together and added  array
		...
		if(activePlayer === 'O') {
			//this function disables clicking for a computers choice
			disableClick();
...
function disableClick() {
	...
	setTimeout(function() {body.style.pointerEvents = 
'auto';}, 1000);
}
...
//this function utilizes html canvas win lines
